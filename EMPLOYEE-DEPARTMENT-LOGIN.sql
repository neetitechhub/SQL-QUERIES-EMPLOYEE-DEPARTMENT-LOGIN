...
--FIND THE TOTAL NUMBER OF HOURS WORKED BY EACH EMPLOYEE ON A SPECIFIC DATE (eg. 2024-08-01):
SELECT E.EMPLOYEEID,
       E.FIRSTNAME,
       E.LASTNAME,
...
--LIST EMPLOYEES WHO HAVE NOT LOGGED IN ON A SPECIFIC DATE (eg. 2024-08-01):
...
--FIND THE AVERAGE WORK DURATION PER EMPLOYEE FOR A GIVEN DATE (eg- 2024-08-01).
SELECT E.EMPLOYEEID,
       E.FIRSTNAME,
       E.LASTNAME,
